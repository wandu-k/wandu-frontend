...
const MyInfoPage = () => {
  ...
  useEffect(() => {
    fetchMiniHomeData();
    axios
      .get("https://wookportfolio.duckdns.org:81/api/my/statistics", {
        headers: {
  ...
  const handleEditMiniHome = () => {
    axios
      .patch(
        `https://wookportfolio.duckdns.org:81/api/user/${userInfo.userId}/minihome/${miniHome.hpId}`,
        {
  ...
  const handleEditProfile = () => {
    ...
    axios
      .put(`https://wookportfolio.duckdns.org:81/api/user`, formData, {
        headers: {
          Authorization: localStorage.getItem("accessToken"),
  ...
  const loadPlayList = () => {
    axios
      .get("https://wookportfolio.duckdns.org:81/api/my/playlist", {
  ...
  const addNewPlayList = (data) => {
    ...
    axios
      .post(
        "https://wookportfolio.duckdns.org:81/api/my/playlist",
        {
          plName: plName,
        },
        {
  ...
  const handlePlaylistDelete = (playlistId) => {
    axios
      .delete(`https://wookportfolio.duckdns.org:81/api/my/playlist/${playlistId}`, {
        headers: { Authorization: localStorage.getItem("accessToken") },
      })
      .then((response) => {
        Notify.success(response.data);
  ...
  const editPlayList = (data) => {
    ...
    axios
      .put(
        `https://wookportfolio.duckdns.org:81/api/my/playlist/${selectedPlaylist.playlistId}`,
        {
          plName: plName,
        },
        {
  ...
  const handleSetPlaylist = (playlistId) => {
    axios
      .patch(
        `https://wookportfolio.duckdns.org:81/api/user/${userInfo.userId}/minihome/${miniHome.hpId}/playlist`,
        playlistId,
